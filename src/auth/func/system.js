...
const API_URL_ENROLLMENT = "src/database/controllers/enrollment_controller.php";
const API_URL_STUDENTS = "src/database/controllers/student_controller.php";
const API_URL_TEACHERS = "src/database/controllers/teacher_controller.php";
const API_URL_STAFFS = "src/database/controllers/staffs_controller.php";
const API_URL_SY = "src/database/controllers/schoolyear_controller.php";
const API_URL_SECTIONS = "src/database/controllers/sections_controller.php";
const API_URL_STRANDS = "src/database/controllers/strands_controller.php";
const API_URL_SUBJECTS = "src/database/controllers/subjects_controller.php";
const API_URL_QUIZ = "src/database/controllers/quiz_controller.php";
