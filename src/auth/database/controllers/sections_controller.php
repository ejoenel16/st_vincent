...
if (!$option) {
    ...
    $q = '
            SELECT 
                ...
                B.id as strand_id,
                CONCAT(C.firstname," ",C.lastname) as adviser_name,
                C.id as adviser_id
            FROM
                tbl_sections A
            LEFT JOIN
...
// CUSTOMIZED FUNCTIONS HERE
...
} else if ($option == "get_section_students_by_subject_id") {
    ...
    $q = '
        SELECT 
            B.lrn,
            CONCAT(C.firstname," ",C.lastname) as student
        FROM
            tbl_section_schedule A
        LEFT JOIN
...
} else if ($option == "get_section_student_grades_by_subject_id") {
