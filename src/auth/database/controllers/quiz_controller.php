...
// CUSTOMIZED FUNCTIONS HERE
    ...
    $correctAnswerValue = $_POST['correct_answer'];
    ...
    $d = [
        'option_value' => $correctAnswerValue,
        'quiz_question_id' => $quizQuestionId
    ];

    $quizOptionId = $db->read($q, $d)[0]['id'];
