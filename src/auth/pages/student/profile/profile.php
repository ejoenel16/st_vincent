            ...
            <div class="col-4 px-0">
                <div class="bg-white p-4">
                    ...
                    <div class="d-flex justify-content-center align-items-center flex-column">
                        <img src="src/img/1.jpg" id="student_photo" class="my-3 border p-1"
                            style="height:205px; width:205px;" alt="">
                        <label id="student_header_name" style="font-size:15pt; font-weight:500">Gonzales, Miguel
                            Sebastian</label>
                        <label id="student_header_email" class="text-muted"
            ...
            <div class="col-8 pe-0">
                <div class="bg-white border rounded ">
                    ...
                    <ul class="nav nav-underline border-bottom px-4" id="emp_nav_sp_profile">
                        <li class="nav-item">
                            <a class="nav-link active sp_micro_nav" style="font-size:10pt"
                                show_micropage="sp_micro_page_personal" aria-current="page" href="#">Personal</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link sp_micro_nav" style="font-size:10pt"
                    ...
                    <div class="micropage mt-3  p-2 px-4" id="sp_micro_page_personal"
                        ...
                        <label class="mt-2" style="font-size:10pt">School Year <span
                                class="text-danger">*</span></label>
                        <input type="text" disabled class="form-control form-control-required mb-1" id="sp_school_year">

                        <label class="mt-2" style="font-size:10pt">Grade Level <span
                                class="text-danger">*</span></label>
                        ...
                        <label class="mt-2" style="font-size:10pt">Status <span class="text-danger">*</span></label>
                        ...
                        <label class="mt-2" style="font-size:10pt">Learner Reference Number: <span
                                class="text-danger">*</span></label>
                        ...
                        <label class="mt-2" style="font-size:10pt">Middle Name <span
                                class="text-danger">*</span></label>
                        ...
                        <div class="d-flex mb-2">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" value="male" name="sp_gender_radio_btn"
                                    id="sp_male">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" value="female" name="sp_gender_radio_btn"
                                    id="sp_female">
                        ...
                        <div class="row mt-4">
                            <div class="col">
                                ...
                                <ul id="ad_rc_attachments"
                                    style="list-style-type:'&#128194;';border:1px dashed #DEE2E6"></ul>
                            </div>
                        </div>

                        <button class="btn text-light mt-3" style="background:#0A1881; font-size:10pt"
                            id="sp_btn_profile_save_changes">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button class="btn btn-primary btn-sm" data-bs-dismiss="modal"
                    id="md_confirm_student_change_photo">Confirm</button>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" tabindex="-1" id="md_student_change_password">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button class="btn btn-primary btn-sm" data-bs-dismiss="modal"
                    id="md_confirm_student_change_password">Confirm</button>
            </div>
        </div>
    </div>
</div>