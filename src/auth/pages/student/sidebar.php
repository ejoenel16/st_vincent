    <div class="d-flex flex-column pt-4 justify-content-between  vh-100 border-end bg-white">
        <div>
            ...
            <ul class="sidebar mt-4 mx-0 px-0">
                ...
                <li func="se_load_enrollments" style="font-weight:400" goto="page_enrollment" class="sidebar_btn">
                    <i class="fa-regular fa-rectangle-list fa-fw pe-2"></i> Enrollment
                </li>
                <li func="grading_load" style="font-weight:400" goto="page_grading" id="btn_goto_grading" class="sidebar_btn">
                    <i class="fa-solid fa-chart-column fa-fw pe-2"></i> Grading
                </li>
                <li func="sl_load_sections" style="font-weight:400" goto="page_student_learning" class="sidebar_btn">
