...
<div class="page text-dark vh-100 p-4" id="page_enrollment" style="display:none;">
    ...
    <div class="text-end">
        <button class="btn" style="background:#0A1881; color:#fff; font-size:10pt" id="btn_new_enrollment">New
            Enrollment <i class="fa-solid fa-plus ms-2"></i></button>
    </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <select id="md_new_enrollment_semester" class="form-select">
            ...
            <div class="modal-footer">
                <button class="btn btn-primary btn-sm" data-bs-dismiss="modal"
                    id="md_new_enrollment_btn_confirm">Confirm</button>
            </div>
        </div>
    </div>
</div>