...
<section class="page text-dark vh-100 p-5" style="display:none; background:#FAFBFC" id="page_admission">
    ...
    <div class="minipage" id="mini_page_admission_home">
        ...
        <div class="text-end mb-3">
            <div class="position-relative" style="max-width: 300px;">
                <i class="fa-solid fa-magnifying-glass position-absolute top-50 start-0 translate-middle-y"
                    style="color:#A6AEB8; padding-left: 0.5rem;"></i>
        ...
        <div class="card mt-4 p-1" style="border-radius:10px; border: 1px solid #EAEBF0;">
            ...
            <div class=" table-responsive">
                <table class="table border-top" style="font-size:10pt;" id="tbl_admin_admissions">
                    <thead>
                        <tr>
                            <th class="py-2 text-center" style="color:#5F6D7E; font-weight:500; width: 10%;">LRN</th>
                            <th class="py-2" style="color:#5F6D7E; font-weight:500;">Name</th>
                            <th class="py-2 text-center" style="color:#5F6D7E; font-weight:500; width: 10%;">Grade Level
                            </th>
                            <th class="py-2 text-center" style="color:#5F6D7E; font-weight:500; width: 10%;">Status</th>
                            <th class="py-2" style="color:#5F6D7E; font-weight:500; width: 8%;"></th>
                        </tr>
                    </thead>
                    <tbody></tbody>
                </table>
    ...
    <div class="minipage" style="display:none" id="mini_page_admission_view_application">
        ...
        <div class="card mt-2 p-1"
            style="border-radius:10px; border: 1px solid #EAEBF0;max-height:85vh; overflow-y:auto">
            <div class="container-fluid px-5" style="margin-top:2em;">
                ...
                <div class="row mt-1">
                    <div class="col-12 col-lg-6">
                        ...
                        <input type="text" class="form-control form-control-required" id="a_si_email"
                            placeholder="juandelacruz@example.com">
                    </div>
                    <div class="col-12 col-lg-6">
                        <label class="mt-2">Contact Number: <span class="text-danger">*</span></label>
                        <input type="text" class="form-control form-control-required" id="a_si_contact_no"
                            placeholder="09*********">
                    </div>
                </div>
                    ...
                    <div class="col">
                        ...
                        <div class="d-flex">
                            <div class="form-check me-5">
                                <input class="a_requirement_checklist form-check-input" document_name="SF9"
                                    type="checkbox" id="a_approve_sf9">
                            ...
                            <div class="form-check me-5">
                                <input class="a_requirement_checklist form-check-input" document_name="SF10"
                                    type="checkbox" id="a_approve_sf10">
                            ...
                            <div class="form-check me-5">
                                <input class="a_requirement_checklist form-check-input" document_name="NSO"
                                    type="checkbox" id="a_approve_nso">
                            ...
                            <div class="form-check me-5">
                                <input class="a_requirement_checklist form-check-input" document_name="GMC"
                                    type="checkbox" id="a_approve_gmc">
                            ...
                            <div class="form-check me-5">
                                <input class="a_requirement_checklist form-check-input" document_name="PHOTO"
                                    type="checkbox" id="a_approve_photo">
                ...
                <div class="row my-2">
                    <div class="col text-end">
                        <button class="btn" id="a_btn_admit_student"
                            style="background:#05147B; color:white; font-size:10pt">Admit Student</button>
                    </div>
                </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button class="btn btn-primary btn-sm" data-bs-dismiss="modal"
                    id="btn_cancel_application_confirm">Confirm</button>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" tabindex="-1" id="a_md_confirm_approve_requirement">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button class="btn btn-primary btn-sm" data-bs-dismiss="modal"
                    id="btn_confirm_approve_requirement">Confirm</button>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" tabindex="-1" id="a_md_confirm_disapprove_requirement">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button class="btn btn-primary btn-sm" data-bs-dismiss="modal"
                    id="btn_confirm_disapprove_requirement">Confirm</button>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" tabindex="-1" id="a_md_confirm_admit_student">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button class="btn btn-primary btn-sm" data-bs-dismiss="modal"
                    id="btn_confirm_admit_student">Confirm</button>
            </div>
        </div>
    </div>
</div>