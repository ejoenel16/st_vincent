...
<section class="page text-dark vh-100 p-4" id="page_employees" style="display:none;background:#FAFBFC">
    ...
    <ul class="nav nav-underline mt-4" id="emp_nav">
        <li class="nav-item">
            <a class="nav-link active pe_m_nav" show_minipage="mini_page_teachers" aria-current="page"
                href="#">Teachers</a>
        </li>
        <li class="nav-item">
    ...
    <div class="minipage" id="mini_page_teachers">
        ...
        <div class="text-end">
            <button class="btn" style="background:#0A1881; color:#fff; font-size:10pt" id="btn_add_teacher">Add Teacher
    ...
    <div class="minipage" id="mini_page_add_teacher" style="display:none">
        ...
        <div class="card mt-4 p-1" id="div_tr"
            style="border-radius:10px; border: 1px solid #EAEBF0;max-height:90vh; overflow-y:auto">
            <div class="container-fluid px-5" style="margin-top:2em;">
                ...
                <div class="row mt-1">
                    <div class="col-12 col-lg-6">
                        ...
                        <input type="text" class="form-control form-control-required" id="tr_info_email"
                            placeholder="juandelacruz@example.com">
                    </div>
                    <div class="col-12 col-lg-6">
                        <label class="mt-2">Contact Number: <span class="text-danger">*</span></label>
                        <input type="text" class="form-control form-control-required" id="tr_info_contact_no"
                            placeholder="09*********">
                    </div>
                </div>
                ...
                <div class="row my-2">
                    <div class="col text-end">
                        <button class="btn" id="a_btn_register_teacher"
                            style="background:#05147B; color:white; font-size:10pt">Register Teacher</button>
                    </div>
                </div>
                ...
                <div class="col-4">
                    <div class="bg-white p-4">
                        ...
                        <div class="d-flex justify-content-center align-items-center flex-column">
                            <img src="src/img/1.jpg" id="tp_photo" class="my-3 border"
                                style="height:200px; width:185px;" alt="">
                            <label id="tp_header_name" style="font-size:15pt; font-weight:500">Gonzales, Miguel
                                Sebastian</label>
                            <label id="tp_header_email" class="text-muted"
                                style="font-size:10pt;font-weight:400">gonzalesmiguel@gmail.com</label>
                        </div>
                            ...
                            <div class="row" style="font-weight:500">
                                <div class="col d-grid">
                                    <button class="btn text-light mt-2" style="background:#0A1881; font-size:10pt"
                                        id="btn_edit_teacher_profile_change_photo">
                    ...
                    <div class="bg-white border rounded">
                        <ul class="nav nav-underline border-bottom px-4" id="emp_nav_tp_profile">
                            <li class="nav-item">
                                <a class="nav-link active pe_micro_nav" style="font-size:10pt"
                                    show_micropage="tp_micro_page_personal" aria-current="page" href="#">Personal</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link pe_micro_nav" style="font-size:10pt"
                                    show_micropage="tp_micro_page_change_password" href="#">Change Password</a>
                            </li>
                        </ul>

                        <!-- MICRO PAGE 1 -->
                        <div class="micropage mt-3 p-2 px-4" id="tp_micro_page_personal">
                            <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div class="row">
                                ...
                                <div class="col-6 col-lg-2">
                                    ...
                                    <input type="text" class="form-control form-control-required mb-1" id="tp_info_age"
                                        disabled>
                                </div>
                            </div>
                            ...
                            <button class="btn text-light my-3" id="btn_edit_teacher_profile_save_changes">
                        ...
                        <div class="micropage mt-3  p-2 px-4" id="tp_micro_page_change_password" style="display:none;">
                            ...
                            <button class="btn text-light mt-4" style="background:#0A1881; font-size:10pt"
                                id="btn_changepass_profile_save_changes">
                                Change Password
                            </button>
    ...
    <div class="minipage" id="mini_page_staffs" style="display:none">
        ...
        <div class="text-end">
            <button class="btn" style="background:#0A1881; color:#fff; font-size:10pt" id="btn_add_staff">Add Staff <i
    ...
    <div class="minipage" id="mini_page_add_staff" style="display:none">
        ...
        <div class="card mt-4 p-1" id="div_sr"
            style="border-radius:10px; border: 1px solid #EAEBF0;max-height:90vh; overflow-y:auto">
            <div class="container-fluid px-5" style="margin-top:2em;">
                ...
                <div class="row mt-1">
                    <div class="col-12 col-lg-6">
                        <label class="mt-2">Email Address: <span class="text-danger">*</span></label>
                        <input type="text" class="form-control form-control-required" id="sr_info_email"
                            placeholder="juandelacruz@example.com">
                    </div>
                    <div class="col-12 col-lg-6">
                        <label class="mt-2">Contact Number: <span class="text-danger">*</span></label>
                        <input type="text" class="form-control form-control-required" id="sr_info_contact_no"
                            placeholder="09*********">
                    </div>
                </div>
                ...
                <div class="row my-2">
                    <div class="col text-end">
                        <button class="btn" id="a_btn_register_staff"
                            style="background:#05147B; color:white; font-size:10pt">Register Staff</button>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-4">
                    <div class="bg-white p-4">
                        ...
                        <div class="d-flex justify-content-center align-items-center flex-column">
                            <img src="src/img/1.jpg" id="sp_photo" class="my-3 border"
                                style="height:200px; width:185px;" alt="">
                            <label id="sp_header_name" style="font-size:15pt; font-weight:500">Gonzales, Miguel
                                Sebastian</label>
                            <label id="sp_header_email" class="text-muted"
                                style="font-size:10pt;font-weight:400">gonzalesmiguel@gmail.com</label>
                        </div>
                        ...
                        <div class="container-fluid mt-2">
                            <div class="row" style="font-weight:500">
                                <div class="col d-grid">
                                    <button class="btn text-light mt-2" style="background:#0A1881; font-size:10pt"
                                        id="sp_btn_edit_teacher_profile_change_photo">
                                        <i class="fa-solid fa-camera"></i> Change Photo
                                    </button>
                                </div>
                            </div>
                ...
                <div class="col-8 pe-0">
                    <div class="bg-white border rounded">
                        ...
                        <ul class="nav nav-underline border-bottom px-4" id="emp_nav_sp_profile">
                            <li class="nav-item">
                                <a class="nav-link active pe_micro_nav" style="font-size:10pt"
                                    show_micropage="sp_micro_page_personal" aria-current="page" href="#">Personal</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link pe_micro_nav" style="font-size:10pt"
                                    show_micropage="sp_micro_page_change_password" href="#">Change Password</a>
                            </li>
                        </ul>
                        ...
                        <div class="micropage mt-3  p-2 px-4" id="sp_micro_page_personal">
                            ...
                            <div class="row">
                                ...
                                <div class="col-6 col-lg-2">
                                    <label class="mt-2" style="font-size:10pt">Age </label>
                                    <input type="text" class="form-control form-control-required mb-1" id="sp_info_age"
                                        disabled>
                                </div>
                            </div>
                            ...
                            <div class="row mt-1">
                                <div class="col-12 col-lg-6">
                                    <label class="mt-2" style="font-size:10pt;">Relationship</label>
                                    <select name="" id="sp_info_e_relationship"
                            ...
                            <button class="btn text-light mt-3" style="background:#0A1881; font-size:10pt"
                                id="btn_edit_staff_profile_save_changes">
                                <i class="fa-solid fa-floppy-disk"></i> Save Changes
                            </button>
                        ...
                        <div class="micropage mt-3  p-2 px-4" id="sp_micro_page_change_password" style="display:none;">
                            ...
                            <button class="btn text-light mt-4" style="background:#0A1881; font-size:10pt"
                                id="sp_btn_changepass_profile_save_changes">
                                Change Password
                            </button>
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button class="btn btn-primary btn-sm" data-bs-dismiss="modal"
                    id="employee_btn_teacher_confirm_archive">Confirm</button>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" tabindex="-1" id="employee_md_add_subject_to_teacher">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button class="btn btn-primary btn-sm" data-bs-dismiss="modal"
                    id="employee_md_add_subject_to_teacher_confirm">Confirm</button>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" tabindex="-1" id="employee_md_tp_changephoto">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button class="btn btn-primary btn-sm" data-bs-dismiss="modal"
                    id="employee_md_tp_btn_confirm">Confirm</button>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" tabindex="-1" id="sp_employee_md_tp_changephoto">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button class="btn btn-primary btn-sm" data-bs-dismiss="modal"
                    id="sp_employee_md_tp_btn_confirm">Confirm</button>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" tabindex="-1" id="employee_md_tp_changepassword">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button class="btn btn-primary btn-sm" data-bs-dismiss="modal"
                    id="employee_md_tp_changepassword_btn_confirm">Confirm</button>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" tabindex="-1" id="e_md_staff_archive">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button class="btn btn-primary btn-sm" data-bs-dismiss="modal"
                    id="e_md_staff_archive_btn_confirm">Confirm</button>
            </div>
        </div>
    </div>
</div>