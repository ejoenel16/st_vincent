...
<section class="page text-dark vh-100 p-5" style="display:none" id="page_schoolyear">
    ...
    <div class="text-end mb-3">
        <button class="btn btn-primary btn-sm" id="btn_add_sy">
            Add School Year <i class="fa-solid fa-plus ms-2"></i>
        </button>
    </div>

    <div class="card mt-4 p-3" style="border-radius:10px; border: 1px solid #EAEBF0">
        <h6 class="ps-2 pt-3 pb-2">List of School Year</h6>

        <div class="table-responsive">
            <table class="table table-bordered" style="font-size:10pt;" id="tbl_admin_sy">
                <thead>
                    <tr>
                        <th class="text-center" width="5%" style="color:#5F6D7E; font-weight:500">No</th>
                        <th style="color:#5F6D7E; font-weight:500">School Year</th>
                        <th width="10%" class="text-center" style="color:#5F6D7E; font-weight:500">Status</th>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button class="btn btn-sm text-white" style="background:#F04438" data-bs-dismiss="modal"
                    id="sy_md_btn_del_confirm">Delete</button>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button class="btn btn-primary btn-sm" data-bs-dismiss="modal"
                    id="sy_md_btn_edit_confirm">Confirm</button>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" tabindex="-1" id="sy_md_add">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button class="btn btn-primary btn-sm" data-bs-dismiss="modal"
                    id="sy_md_btn_add_confirm">Confirm</button>
            </div>
        </div>
    </div>
</div>