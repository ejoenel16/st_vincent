...
<section class="page text-dark vh-100 p-5" id="page_sections" style="display:none">
    ...
    <div class="minipage" id="mini_page_section_home">
        ...
        <div class="text-end">
            <button class="btn" style="background:#0A1881; color:#fff; font-size:10pt" id="btn_add_section">Add Section
        ...
        <div class="card mt-4 p-1" style="border-radius:10px; border: 1px solid #EAEBF0">
            ...
            <table class="table border-top" style="font-size:10pt; " id="tbl_admin_sections">
                <thead>
                    ...
                    <th class="py-2" width="42%" style="color:#5F6D7E; font-weight:500">
                        Strand
                    </th>

                    <th class="py-2 text-center" width="8%" style="color:#5F6D7E; font-weight:500"></th>
                </thead>
                <tbody></tbody>
            </table>
    ...
    <div class="minipage" id="mini_page_section_schedule" style="display:none">
        ...
        <div class="d-flex justify-content-between align-items-center">
            ...
            <button class="btn border rounded" id="a_btn_close_sections_schedule"><i
                    class="fa-solid fa-xmark"></i></button>
        </div>

        <div class="card mt-5 p-1" id="card_section_schedule"
            style="border-radius:10px; border: 1px solid #EAEBF0; max-height:80vh; overflow-y:auto">
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <select id="md_sections_sel_strand" class="form-select"></select>
            ...
            <div class="modal-footer">
                <button class="btn btn-primary btn-sm" data-bs-dismiss="modal"
                    id="md_sections_add_btn_confirm">Confirm</button>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" tabindex="-1" id="md_sections_edit">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button class="btn btn-primary btn-sm" data-bs-dismiss="modal"
                    id="md_sections_edit_add_btn_confirm">Confirm</button>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" tabindex="-1" id="md_archive_section">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button class="btn btn-primary btn-sm" data-bs-dismiss="modal"
                    id="md_archive_section_btn_confirm">Confirm</button>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" tabindex="-1" id="md_section_add_schedule">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
                    ...
                    <div class="container-fluid">
                        <div class="row d-flex align-items-center mb-2">
                            <div class="col-1 d-flex flex-column">
                                ...
                                <input style="font-size:16pt" class="form-check-input chk_subject_schedule_day"
                                    type="checkbox" value="M" id="md_section_schedule_chk_monday">
                            </div>
                            <div class="col-5">
                                <label>From: <span class="text-danger">*</span></label>
                                <input type="time" class="form-control form-control-sm"
                                    id="md_section_schedule_monday_from">
                            </div>
                            <div class="col-5">
                                <label>To: <span class="text-danger">*</span></label>
                                <input type="time" class="form-control form-control-sm"
                                    id="md_section_schedule_monday_to">
                            </div>
                        </div>
                        ...
                        <div class="row d-flex align-items-center mb-2">
                            <div class="col-1 d-flex flex-column">
                                ...
                                <input style="font-size:16pt" class="form-check-input chk_subject_schedule_day"
                                    type="checkbox" value="T" id="md_section_schedule_chk_tuesday">
                            </div>
                            <div class="col-5">
                                <label>From: <span class="text-danger">*</span></label>
                                <input type="time" class="form-control form-control-sm"
                                    id="md_section_schedule_tuesday_from">
                            </div>
                            <div class="col-5">
                                <label>To: <span class="text-danger">*</span></label>
                                <input type="time" class="form-control form-control-sm"
                                    id="md_section_schedule_tuesday_to">
                            </div>
                        </div>
                        ...
                        <div class="row d-flex align-items-center mb-2">
                            <div class="col-1 d-flex flex-column">
                                ...
                                <input style="font-size:16pt" class="form-check-input chk_subject_schedule_day"
                                    type="checkbox" value="W" id="md_section_schedule_chk_wednesday">
                            </div>
                            <div class="col-5">
                                <label>From: <span class="text-danger">*</span></label>
                                <input type="time" class="form-control form-control-sm"
                                    id="md_section_schedule_wednesday_from">
                            </div>
                            <div class="col-5">
                                <label>To: <span class="text-danger">*</span></label>
                                <input type="time" class="form-control form-control-sm"
                                    id="md_section_schedule_wednesday_to">
                            </div>
                        </div>
                        ...
                        <div class="row d-flex align-items-center mb-2">
                            <div class="col-1 d-flex flex-column">
                                ...
                                <input style="font-size:16pt" class="form-check-input chk_subject_schedule_day"
                                    type="checkbox" value="TH" id="md_section_schedule_chk_thursday">

                            </div>
                            <div class="col-5">
                                <label>From: <span class="text-danger">*</span></label>
                                <input type="time" class="form-control form-control-sm"
                                    id="md_section_schedule_thursday_from">
                            </div>
                            <div class="col-5">
                                <label>To: <span class="text-danger">*</span></label>
                                <input type="time" class="form-control form-control-sm"
                                    id="md_section_schedule_thursday_to">
                            </div>
                        </div>
                        ...
                        <div class="row d-flex align-items-center mb-2">
                            <div class="col-1 d-flex flex-column">
                                ...
                                <input style="font-size:16pt" class="form-check-input chk_subject_schedule_day"
                                    type="checkbox" value="F" id="md_section_schedule_chk_friday">
                            </div>
                            <div class="col-5">
                                <label>From: <span class="text-danger">*</span></label>
                                <input type="time" class="form-control form-control-sm"
                                    id="md_section_schedule_friday_from">
                            </div>
                            <div class="col-5">
                                <label>To: <span class="text-danger">*</span></label>
                                <input type="time" class="form-control form-control-sm"
                                    id="md_section_schedule_friday_to">
                            </div>
                        </div>
                        ...
                        <div class="row d-flex align-items-center mb-2">
                            <div class="col-1 d-flex flex-column">
                                ...
                                <input style="font-size:16pt" class="form-check-input chk_subject_schedule_day"
                                    type="checkbox" value="S" id="md_section_schedule_chk_saturday">
                            </div>
                            <div class="col-5">
                                <label>From: <span class="text-danger">*</span></label>
                                <input type="time" class="form-control form-control-sm"
                                    id="md_section_schedule_saturday_from">
                            </div>
                            <div class="col-5">
                                <label>To: <span class="text-danger">*</span></label>
                                <input type="time" class="form-control form-control-sm"
                                    id="md_section_schedule_saturday_to">
                            </div>
                        </div>
            ...
            <div class="modal-footer">
                <button class="btn btn-primary btn-sm" data-bs-dismiss="modal"
                    id="md_section_add_schedule_btn_confirm">Confirm</button>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" tabindex="-1" id="md_section_edit_schedule">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
                    ...
                    <div class="container-fluid">
                        <div class="row d-flex align-items-center mb-2">
                            <div class="col-1 d-flex flex-column">
                                ...
                                <input style="font-size:16pt" class="form-check-input chk_subject_schedule_day"
                                    type="checkbox" value="M" id="edit_md_section_schedule_chk_monday">
                            </div>
                            <div class="col-5">
                                <label>From: <span class="text-danger">*</span></label>
                                <input type="time" class="form-control form-control-sm schedule_edit_day" disabled
                                    id="edit_md_section_schedule_monday_from">
                            </div>
                            <div class="col-5">
                                <label>To: <span class="text-danger">*</span></label>
                                <input type="time" class="form-control form-control-sm schedule_edit_day" disabled
                                    id="edit_md_section_schedule_monday_to">
                            </div>
                        </div>
                        ...
                        <div class="row d-flex align-items-center mb-2">
                            <div class="col-1 d-flex flex-column">
                                ...
                                <input style="font-size:16pt" class="form-check-input chk_subject_schedule_day"
                                    type="checkbox" value="T" id="edit_md_section_schedule_chk_tuesday">
                            </div>
                            <div class="col-5">
                                <label>From: <span class="text-danger">*</span></label>
                                <input type="time" class="form-control form-control-sm schedule_edit_day" disabled
                                    id="edit_md_section_schedule_tuesday_from">
                            </div>
                            <div class="col-5">
                                <label>To: <span class="text-danger">*</span></label>
                                <input type="time" class="form-control form-control-sm schedule_edit_day" disabled
                                    id="edit_md_section_schedule_tuesday_to">
                            </div>
                        </div>
                        ...
                        <div class="row d-flex align-items-center mb-2">
                            <div class="col-1 d-flex flex-column">
                                ...
                                <input style="font-size:16pt" class="form-check-input chk_subject_schedule_day"
                                    type="checkbox" value="W" id="edit_md_section_schedule_chk_wednesday">
                            </div>
                            <div class="col-5">
                                <label>From: <span class="text-danger">*</span></label>
                                <input type="time" class="form-control form-control-sm schedule_edit_day" disabled
                                    id="edit_md_section_schedule_wednesday_from">
                            </div>
                            <div class="col-5">
                                <label>To: <span class="text-danger">*</span></label>
                                <input type="time" class="form-control form-control-sm schedule_edit_day" disabled
                                    id="edit_md_section_schedule_wednesday_to">
                            </div>
                        </div>
                        ...
                        <div class="row d-flex align-items-center mb-2">
                            <div class="col-1 d-flex flex-column">
                                ...
                                <input style="font-size:16pt" class="form-check-input chk_subject_schedule_day"
                                    type="checkbox" value="TH" id="edit_md_section_schedule_chk_thursday">

                            </div>
                            <div class="col-5">
                                <label>From: <span class="text-danger">*</span></label>
                                <input type="time" class="form-control form-control-sm schedule_edit_day" disabled
                                    id="edit_md_section_schedule_thursday_from">
                            </div>
                            <div class="col-5">
                                <label>To: <span class="text-danger">*</span></label>
                                <input type="time" class="form-control form-control-sm schedule_edit_day" disabled
                                    id="edit_md_section_schedule_thursday_to">
                            </div>
                        </div>
                        ...
                        <div class="row d-flex align-items-center mb-2">
                            <div class="col-1 d-flex flex-column">
                                ...
                                <input style="font-size:16pt" class="form-check-input chk_subject_schedule_day"
                                    type="checkbox" value="F" id="edit_md_section_schedule_chk_friday">
                            </div>
                            <div class="col-5">
                                <label>From: <span class="text-danger">*</span></label>
                                <input type="time" class="form-control form-control-sm schedule_edit_day" disabled
                                    id="edit_md_section_schedule_friday_from">
                            </div>
                            <div class="col-5">
                                <label>To: <span class="text-danger">*</span></label>
                                <input type="time" class="form-control form-control-sm schedule_edit_day" disabled
                                    id="edit_md_section_schedule_friday_to">
                            </div>
                        </div>
                        ...
                        <div class="row d-flex align-items-center mb-2">
                            <div class="col-1 d-flex flex-column">
                                ...
                                <input style="font-size:16pt" class="form-check-input chk_subject_schedule_day"
                                    type="checkbox" value="S" id="edit_md_section_schedule_chk_saturday">
                            </div>
                            <div class="col-5">
                                <label>From: <span class="text-danger">*</span></label>
                                <input type="time" class="form-control form-control-sm schedule_edit_day" disabled
                                    id="edit_md_section_schedule_saturday_from">
                            </div>
                            <div class="col-5">
                                <label>To: <span class="text-danger">*</span></label>
                                <input type="time" class="form-control form-control-sm schedule_edit_day" disabled
                                    id="edit_md_section_schedule_saturday_to">
                            </div>
                        </div>
            ...
            <div class="modal-footer">
                <button class="btn btn-primary btn-sm" data-bs-dismiss="modal"
                    id="md_section_edit_schedule_btn_confirm">Confirm</button>
            </div>
        </div>
    </div>
</div>