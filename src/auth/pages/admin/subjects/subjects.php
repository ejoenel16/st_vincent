...
<section class="page text-dark vh-100 p-5" id="page_subjects" style="display:none">
    ...
    <div class="minipage" id="strand_home">
        <div class="text-end">
            <button class="btn" style="background:#0A1881; color:#fff; font-size:10pt" id="btn_add_strand">Add Grade
                Level <i class="fa-solid fa-plus ms-2"></i></button>
        </div>
    ...
    <div class="minipage" style="display:none" id="strand_subjects">
        ...
        <div class="text-end d-flex align-items-center justify-content-between">
            <button class="btn border" style="  font-size:10pt ; width:120px;"
                id="btn_strand_subject_back">Back</button>
            <button class="btn" style="background:#0A1881; color:#fff; font-size:10pt" id="btn_add_subject">Add Subject
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button class="btn btn-primary btn-sm" data-bs-dismiss="modal"
                    id="strands_btn_confirm_edit">Confirm</button>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" tabindex="-1" id="strands_md_delete">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button class="btn btn-primary btn-sm" data-bs-dismiss="modal"
                    id="strands_btn_confirm_delete">Confirm</button>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" tabindex="-1" id="strands_md_add">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button class="btn btn-primary btn-sm" data-bs-dismiss="modal"
                    id="strands_btn_confirm_add">Confirm</button>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" tabindex="-1" id="subjects_md_add">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button class="btn btn-primary btn-sm" data-bs-dismiss="modal"
                    id="subjects_btn_confirm_add">Confirm</button>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" tabindex="-1" id="subjects_md_remove_subject">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button class="btn btn-primary btn-sm" data-bs-dismiss="modal"
                    id="btn_subjects_md_removeconfirm">Confirm</button>
            </div>
        </div>
    </div>
</div>