    <div class="d-flex flex-column pt-4 justify-content-between  vh-100 border-end">
        <div>
            ...
            <ul class="sidebar mt-4 mx-0 px-0">
                ...
                <li func="tm_load_students" style="font-weight:400" goto="page_students" default_page="minipage_students_home" class="sidebar_btn">
                    <i class="fa-solid fa-user-group fa-fw pe-2"></i> Students
                </li>

                <li func="load_teacher_schedule" style="font-weight:400" goto="page_schedule" default_page="page_schedule" class="sidebar_btn">
                    <i class="fa-solid fa-calendar-days fa-fw pe-2"></i> Schedule
                </li>

                <li func="sl_load_sections" style="font-weight:400" goto="page_student_learning" default_page="strand_home" class="sidebar_btn">
