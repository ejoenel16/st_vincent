            ...
            <div class="col-4 px-0">
                <div class="bg-white p-4">
                    ...
                    <div class="d-flex justify-content-center align-items-center flex-column">
                        <img src="src/img/1.jpg" id="teacher_photo" class="my-3 border p-1"
                            style="height:205px; width:205px;" alt="">
                        <label id="teacher_header_name" style="font-size:15pt; font-weight:500">Gonzales, Miguel
                            Sebastian</label>
                        <label id="teacher_header_email" class="text-muted"
                    ...
                    <div class="micropage mt-3  p-2 px-4" id="sp_micro_page_personal"
                        ...
                        <div class="row">
                            <div class="col-6 col-lg-10">
                                <label class="mt-2" style="font-size:10pt">Date of Birth <span
                                        class="text-danger">*</span></label>
                                <input type="date" class="form-control form-control-required mb-1" id="sp_birthdate">
                            </div>
                            <div class="col-6 col-lg-2">
                                <label class="mt-2" style="font-size:10pt">Age <span
                                        class="text-danger">*</span></label>
                        ...
                        <label class="mt-2" style="font-size:10pt">Email Address <span
                                class="text-danger">*</span></label>
                        ...
                        <button class="btn text-light mt-3 float-end" style="background:#0A1881; font-size:10pt"
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button class="btn btn-primary btn-sm" data-bs-dismiss="modal"
                    id="md_confirm_teacher_change_photo">Confirm</button>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" tabindex="-1" id="md_teacher_change_password">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button class="btn btn-primary btn-sm" data-bs-dismiss="modal"
                    id="md_confirm_teacher_change_password">Confirm</button>
            </div>
        </div>
    </div>
</div>